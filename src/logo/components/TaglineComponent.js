                ...
                <div className="logomator-form">
                    ...
                    <form name="tagline-form">
                        ...
                        <div className={ this.state.hasTagline ? 'show' : 'no-show' } style={{marginTop: '30px'}}>
                            ...
                            {
                                this.state.tagline.length > 20 ? 
                                <p style={{ color: 'red', marginBottom: 0 }}>
                                    Please use a shorter slogan to fit in the logo design
                                </p> : ''
                            ...
                            <button onClick={ e =>{
                               ...
                               this.props.history.push('/industry');
                                    ...
                                    className={ (this.state.tagline.length > 0 && this.state.tagline.length <= 20) ? 'logomator-btn' : 'logomator-btn btn-disabled' }
