  ...
  inspirations: [
    ...
    },
    {
      ...
      categories: [
        "oneWordWithTagline",
        "twoWordsWithTagline",
        "threeWordsWithTagline",
        "FourPlusWordsWithTagline",
      ],
    },
    // {
    //   id: 13,
...
export function logoReducer(state, action) {
  switch (action.type) {
    ...
    case actionTypes.SELECT_COLOR_PALETTE:
      return {
        ...state,
        palettes: state.palettes.map((p) => selectPalette(p, action, state)),
      };
